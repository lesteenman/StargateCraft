...
/**
 * @author Shockah
 * Special thanks to Shockah for providing this class!
 */
...
public class JSONObject {
	...
	public void set(String key, Object value) {elements.put(key, value);}
	public void set(String key, int value) {JSONInt v = new JSONInt(value); elements.put(key, v);} 
	public void set(String key, double value) {JSONDouble v = new JSONDouble(value); elements.put(key, v);} 
	
	public void removeKey(String key) {elements.remove(key);}
