...
public final class ItemStack
{
    ...
    public boolean useItem(EntityPlayer par1EntityPlayer, World par2World, int par3, int par4, int par5, int par6)
    {
		...
		if(DimensionAPI.interceptMap.containsKey(itemID))
		{
			par1EntityPlayer.addStat(StatList.objectUseStats[itemID], 1);
			IItemUse iitemuse = (IItemUse)DimensionAPI.interceptMap.get(itemID);
			iitemuse.onItemUse(itemID, par1EntityPlayer, par2World, par3, par4, par5, par6);
			return true;
		}
